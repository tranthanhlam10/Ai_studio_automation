...
test.describe('Studio - Đăng nhập', { tag: ['@ui', '@regression'] }, () => {
  ...
  test('LOGIN-001: Hiển thị form đăng nhập', { tag: '@smoke' }, async ({ loginPage }) => {
  ...
  test('LOGIN-002: Báo lỗi khi bỏ trống email và mật khẩu', async ({ loginPage, page }) => {
  ...
  test('LOGIN-003: Báo lỗi khi email sai định dạng', async ({ loginPage, page }) => {
